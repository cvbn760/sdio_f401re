...
static const osThreadAttr_t gpio_task_attributes = {.name = "gpio_task", .stack_size = 1024, .priority = (osPriority_t) osPriorityRealtime,};
...
static const osThreadAttr_t ind_task_attributes = {.name = "ind_task", .stack_size = 1024, .priority = (osPriority_t) osPriorityRealtime,};
